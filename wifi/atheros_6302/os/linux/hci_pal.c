//------------------------------------------------------------------------------
// <copyright file="hci_pal.c" company="Atheros">
...
// 
// <summary>
// 	PAL driver for AR3001
// </summary>
//
//------------------------------------------------------------------------------
//==============================================================================
// HCI PAL implementation
//
// Author(s): ="Atheros"
//==============================================================================
...
static A_STATUS bt_setup_hci_pal(ar6k_hci_pal_info_t *pHciPalInfo)
{
	...
	do {
		...
		status = HIFConfigureDevice(pHciPalInfo->ar->arHifDevice, 
				HIF_DEVICE_GET_OS_DEVICE,
				&osDevInfo, 
				sizeof(osDevInfo));

		if (A_FAILED(status)) {
			PRIN_LOG("Failed to OS device info from HIF\n");
			break;
		}
