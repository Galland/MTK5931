...
#ifdef  CONFIG_AR6102_FIRMWARE_FILE
char *tgt_fw = CONFIG_AR6102_FIRMWARE_FILE;
#else
char *tgt_fw = "/system/wifi/athwlan.bin.z77";
#endif
#ifdef CONFIG_AR6102_PATCH_FILE
char *tgt_patch = CONFIG_AR6102_PATCH_FILE;
#else
...
#ifdef CONFIG_AR6102_BOARD_DATA_FILE
char *eeprom_file = CONFIG_AR6102_BOARD_DATA_FILE;
#else
...
#ifndef CONFIG_AR6102_FIRMWARE_FILE
...
#if 1	//use firmware in kernel instead of this
    if (tgt_fw != NULL) {
